...
process.g4SimHits.G4CheckOverlap.OutputBaseName = cms.string("Run4D121")
process.g4SimHits.G4CheckOverlap.OverlapFlag = cms.bool(False)
process.g4SimHits.G4CheckOverlap.Tolerance  = cms.double(0.0)
process.g4SimHits.G4CheckOverlap.Resolution = cms.int32(100)
...
process.g4SimHits.FileNameGDML    = 'geometryD121.gdml'
